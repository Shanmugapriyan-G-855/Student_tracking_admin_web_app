...
public class Student_Creation_Positive_Test extends BaseClass {
	...
	public void student_creation(String imagePath,String idNumber,String name,String countryCode1,String mobileNumber1,String countryCode2,String mobileNumber2,String classNo,String bloodGroup,String dob,String gender,String email,String nationality,String address,String mode,String busStop) throws InterruptedException {
	...
	public Object[][] getStudentData(){
		return new Object[][] {{"C:\\Users\\DELL\\Downloads\\images (7).jpeg","STD1001","Hanshika","UAE (+971)","989898989","IND (+91)","9887766555","1-A","AB-ve","2002-05-23","Female","januexample@gmail.com","United Arab Emirates","2/84,Nehru Street","School Bus","Kumalan Kuttai"}};
	}
}
